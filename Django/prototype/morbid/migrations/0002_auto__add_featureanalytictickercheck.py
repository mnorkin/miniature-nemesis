...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FeatureAnalyticTickerCheck'
        db.create_table('morbid_featureanalytictickercheck', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.FloatField')()),
            ('feature_analytic_ticker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['morbid.FeatureAnalyticTicker'])),
        ))
        db.send_create_signal('morbid', ['FeatureAnalyticTickerCheck'])


    def backwards(self, orm):
        # Deleting model 'FeatureAnalyticTickerCheck'
        db.delete_table('morbid_featureanalytictickercheck')
